    ...
    <div class="container">
        ...
        <div id="basicos" class="seccion activa">
            <div class="productos">
                ...
                <div class="card">
                    <h3>67 SHELBY GT500</h3>
                    <div class="precio">$3.25</div>
                </div>
                <div class="card">
                    <h3>CUSTOM 18 FORD MUSTANG GT</h3>
                    <div class="precio">$3.25</div>
                </div>
                <div class="card">
                ...
                <div class="card">
                    <h3>NISSAN SKYLINE GT-R (BCNR33)</h3>
                    <div class="precio">$3.25</div>
                </div>
                <div class="card">
                    <h3>BACK TO THE FUTURE TIME MACHINE - HOVER MODE</h3>
                    <div class="precio">$7.25</div>
                </div>
                <div class="card">
                    <h3>PASS N GO</h3>
                ...
                <div class="card">
                    <h3>BATMAN ARKHAM KNIGHT BATMOBILE (AZUL)</h3>
                    <div class="precio">$5.00</div>
                </div>

                <!-- NUEVO -->
                <div class="card">
                    <h3>🔥 GORDON MURRAY AUTOMOTIVE T.33</h3>
                    <div class="precio">$5.00</div>
                </div>
        ...
        <div id="packs" class="seccion">
            <div class="productos">
                ...
                <div class="card">
                    <h3>HW REMOTE ADVENTURES</h3>
                    <div class="precio">$13</div>
                </div>
                <div class="card">
                    <h3>HW FLAMES</h3>
                    <div class="precio">$13</div>
